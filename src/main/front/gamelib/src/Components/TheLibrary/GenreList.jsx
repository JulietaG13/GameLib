            ...
            <div className="pr-10 sticky top-0">
                ...
                {genreList.map((genre, index) => (
                    <div
                        ...
                        className={`border-b-2 border-black hover:text-xl text-black flex gap-1 items-center mb-3 cursor-pointer hover:bg-gray-800 hover:rounded-xl p-5 rounded-lg group ${activeIndex === index ? "bg-gray-950 text-white rounded-xl" : ""}`}
                    >
